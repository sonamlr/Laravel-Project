                  ...
                  <div class="col-12">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <form action="{{ route('store.pendrive') }}" method="post">
                              @csrf
                              <div class="row mb-3">
                                  <label for="pendrive" class="col-sm-2 col-form-label">Pendrive</label>
                                  <div class="col-sm-10">
                                      <input class="form-control" name="pendrive" type="text" placeholder="Pendrive" id="pendriveid" required>
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-sm-10">
                                      <input class="form-control" name="activation" type="text" placeholder="Activation Code" id="codeid">
                                  </div>
                              </div>
                              <!-- end row -->
                              <div class="row mb-3">
                                  ...
                                  <div class="col-sm-10">
                                      <input class="form-control" name="validity" type="text" placeholder="Validity Time" id="validityid">
                                  </div>
                              </div>
                              <!-- end row -->
                              <div class="row mb-3">
                                  ...
                                  <div class="col-sm-10">
                                      <input class="form-control" name="remaining" type="number" placeholder="Remaining Days" id="remailningid">
                                  </div>
                              </div>
                              <!-- end row -->
                              <div class="row mb-3">
                                  ...
                                  <div class="col-sm-10">
                                      <input class="form-control" name="validityapp" type="text" placeholder="App Validity" id="appvid">
                                  </div>
                              </div>
                              <!-- end row -->
                              <div class="row mb-3">
                                  ...
                                  <div class="col-sm-10">
                                      <input class="form-control" name="defaultpass" placeholder="Default Password" type="password" id="passid">
                                  </div>
                              </div>
                              <div class="row mb-3">
                                  <label for="installpname" class="col-sm-2 col-form-label">Installation Person Name</label>
                                  <div class="col-sm-10">
                                      <input class="form-control" name="installpname" placeholder="Installation Person Name" type="text" id="personid">
                                    </div>
                              </div>
                              {{-- <div class="row  mb-3">
