                                                        ...
                                                        <div>
                                                            ...
                                                            <form action="{{URL::to('loginUser')}}" method="POST">       
                                                                ...
                                                                <div class="mb-2">
                                                                    ...
                                                                    <input type="text" name="user_id" class="form-control" id="username" placeholder="Enter username" required>
																</div>
                                                                <div class="mb-3">
                                                            ...
                                                            @if (session()->has('error'))
                                                                <div class="" style="color: red; text-align:center;"><p>{{session()->get('error')}}</p></div>
                                                            @endif
